            ...
            <Container>
                ...
                <div className="flex flex-col lg:flex-row items-center gap-16">
                    <div className="w-full lg:w-1/2">
                        ...
                        <Button variant="outline-brand" className="rounded-lg">
                            Explore the Dashboard <ArrowRight className="ml-2 h-4 w-4" />
                        </Button>
                    </div>

                    <div className="w-full lg:w-1/2">
                        <div className="relative rounded-2xl overflow-hidden border border-zinc-200 shadow-2xl bg-white aspect-[4/3] group">
                            <Image
                                src="/dashboard.jpg"
