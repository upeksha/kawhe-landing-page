        ...
        <section className="py-24 bg-white" id="use-cases">
            <Container>
                <div className="text-center mb-16">
                    <span className="text-sm font-semibold text-brand uppercase tracking-wider mb-2 block">Versatility</span>
                    <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">Made for everyday café loyalty.</h2>
                </div>
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {cases.map((item, index) => (
                        ...
                        >
                            <div>
                                <item.icon className={`h-8 w-8 mb-4 ${item.text === "text-white" ? "text-white/90" : "opacity-80"}`} />
